...
document.write('<table id="fc" style="z-index:10000;position:absolute;border-collapse:collapse;background:#FFFFFF;border:1px solid #cccccc;display:none" cellpadding=2>');
...
function cs_over(e) {
	evtTgt(EvtObj(e)).style.background='#f0f1ec';
}
function cs_out(e) {
...
function prepcalendar(hd,cm,cy) {
	...
	for(var d=1;d<=42;d++) {
		...
		if ((d >= (cd -(-1))) && (d<=cd-(-marr[cm]))) {
			...
			if(cm<=8) {var plussik="0";} else {var plussik="";}
			if((d-cd)<=9) {var plussik1="0";} else {var plussik1="";}
			calvalarr[d]=''+cy+'-'+plussik+(cm-(-1))+'-'+plussik1+(d-cd);
		}
		else {
